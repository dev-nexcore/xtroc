      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            {/* Logo */}
            <div className="w-28 h-12 sm:w-32 sm:h-16 bg-gray-800 flex items-center justify-center rounded">
              <img
                src="/xtorc.png"
                alt="Xtorc Logo"
          ...
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-white text-base sm:text-lg font-medium">Company</h3>
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center space-x-2">
                <FaAngleDoubleRight className="text-red-500 text-xs sm:text-sm flex-shrink-0" />
                <a
                  href="#"
          ...
          {/* Products Section */}
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-white text-base sm:text-lg font-medium">Products</h3>
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center space-x-2">
                <FaAngleDoubleRight className="text-red-500 text-xs sm:text-sm flex-shrink-0" />
                <a
                  href="#"
                  className="text-white text-xs sm:text-sm hover:text-gray-300 transition-colors line-clamp-2"
                >
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <a
                  ...
                  className="text-white text-xs sm:text-sm hover:text-gray-300 transition-colors break-all"
                >
