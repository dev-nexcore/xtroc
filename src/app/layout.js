...
export const metadata = {
  ...
  description:
    "XTORC provides premium hydraulic torque wrenches, flange facing machines, pipe cutting machines, bolt tensioners, and industrial bolting tools trusted in oil, gas, marine, petrochemical, power plant, and construction industries.",
  keywords: [
    // 🔹 Primary Keywords
