  ...
  return (
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 text-center md:text-left md:pl-12">
              ...
              <p className="text-gray-300 text-base sm:text-lg mb-8 leading-relaxed">
                Welcome to Xtorc, where precision meets innovation. With over 10 years of expertise, 
                we offer top-tier hydraulic torque wrenches, cold cutting machines, and on-site services, 
                all backed by ISO 9001:15000, CE, and ATEX certifications.
              </p>
      ...
      <div className="relative pt-6 sm:pt-8">
        <div className="bg-black bg-opacity-25 px-4 sm:px-8 py-8 relative">
          <div className="max-w-4xl mx-auto text-center relative z-10 pt-4 pb-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">About Us</h2>
            ...
            <p className="text-gray-300 text-base sm:text-lg mb-6 leading-relaxed">
              Xtorc was founded with a vision to provide world-class industrial tools and services tailored to 
              modern challenges. As a startup with over a decade of experience, we're redefining how industries 
              achieve precision, efficiency, and safety. All our products are proudly manufactured in India and 
              certified to the highest standards, including ISO 9001:15000, CE, and ATEX.
            </p>
            
            <p className="text-gray-300 text-base sm:text-lg mb-10 leading-relaxed">
              At Xtorc, we believe in creating value that extends beyond products. Our WIN-WIN-WIN philosophy 
              ensures that our customers win, our employees thrive, and our entrepreneurs succeed.
            </p>
