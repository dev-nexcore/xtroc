  ...
  return (
    <div className="overflow-x-hidden bg-black text-white min-h-screen">
      ...
      <motion.div
        ...
        variants={container}   // ← container variant
        initial="hidden"
        animate="visible"
      >
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 relative">
          ...
          <motion.div variants={fadeInUp} className="flex-1 md:flex-none md:w-[360px] relative">
            <div className="bg-gray-900 py-6 rounded-2xl border-2 border-white shadow-[0_0_0_4px_#D01A1A] w-full max-w-md h-auto mx-auto text-center">
        ...
        <motion.div variants={fadeInUp} className="flex items-center justify-center mt-10">
