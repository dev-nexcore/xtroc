  ...
  <div className="bg-white rounded-2xl p-6 border-t-8 border-r-8 border-red-600 
    ...
    />
          ...
          <div className="space-y-6">
            {/* Title */}
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">Hydraulic Nut Splitters</h1>
            ...
            <div className="space-y-4 text-gray-200 leading-relaxed">
              <p>
                XTORC's Light Weight Hydraulic Nut Splitters are used in applications that 
                involve corrosion; it can be used to remove corroded or seized nuts fast and safely. 
                The light weight option helps the user to apply the product to lower sized bolts.
              </p>
              <p>
                XTORC's offers Weight Hydraulic Nut Splitters for a range of Hex size 0.37" to 2.95". 
                Our product is designed for operator comfort that fits tight spaces and it cuts 
                through the hardest of nuts.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-gray-200">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    • The fast, sure and safe method to cut and remove seized nuts</span>
                </li>
                <li className="flex items-start gap-2">
                  {/* <span className="text-red-600 mt-2">•</span> */}
