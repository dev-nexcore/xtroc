...
const Product = () => {
  return (
    <div className='bg-black'>
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-12 text-left bg-black">
  <h2
    ...
    <div className="overflow-x-hidden">
      <div className="relative translate-x-10 md:absolute top-10 md:-right-16 bg-gray-900 p-6 rounded-2xl border-2 border-white shadow-[0_0_0_4px_#D01A1A] mx-auto md:mx-0 max-w-md w-full overflow-hidden">
        <div className="text-center">
          <h4 
            className="text-xl sm:text-3xl font-semibold mb-2 text-white "
            
          >
            Optimized &
          </h4>
          <h4 
            className="text-xl sm:text-3xl font-semibold mb-4 text-white"
            
          >
            Industry-Ready
          </h4>
          <h4 
            className="text-xl sm:text-3xl font-semibold text-white"
