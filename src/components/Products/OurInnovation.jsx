...
//     ${product.id === 2
//       ? // 👇 mobile-first size for 2nd card only
//         "w-full max-w-xs aspect-square sm:w-52 sm:h-52 md:h-80 md:w-80 lg:h-[500px] lg:w-[500px] rotate-[-90deg]"
//       : "h-52 w-52 md:h-80 md:w-80 lg:h-[500px] lg:w-[500px]"
//     }`}
//   onError={(e) => {
